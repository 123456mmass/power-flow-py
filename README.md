...
- In-house Newton-Raphson AC power flow
- PV reactive-limit switching and structured failure semantics
- CLI and Python API
...
pytest
power-flow --case ieee5 --tolerance 1e-10
```
...
result = solve_case("pf", "ieee14", {"tolerance": 1e-10})
